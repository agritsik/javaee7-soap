 ...
 * 
 */
@WebServiceClient(name = "ProductWSService", targetNamespace = "http://boundary.samples.agritsik.com/", wsdlLocation = "http://192.168.59.103:8081/app/ProductWSService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTWSSERVICE_QNAME = new QName("http://boundary.samples.agritsik.com/", "ProductWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.59.103:8081/app/ProductWSService?wsdl");
    ...
    public ProductWS getProductWSPort() {
        return super.getPort(new QName("http://boundary.samples.agritsik.com/", "ProductWSPort"), ProductWS.class);
    }
    ...
    public ProductWS getProductWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://boundary.samples.agritsik.com/", "ProductWSPort"), ProductWS.class, features);
    }
